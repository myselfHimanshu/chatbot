...
def decode_training_set(encoder_state, decoder_cell, decoder_embedded_input, sequence_length, decoding_scope, output_function, keep_prob, batch_size):
    ...
    attention_score_function, attention_construct_function = tf.contrib.\
    seq2seq.prepare_attention(attention_states, attention_option = "bahdanau", \
    ...
    decoder_final_context_state = tf.contrib.seq2seq.dynamic_rnn_decoder(decoder_cell,
